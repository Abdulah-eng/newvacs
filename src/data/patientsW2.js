...
const michaelTue = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-michael-tue_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had type 2 diabetes and high blood pressure, and passed away from a stroke at age 68. My mother has high blood pressure and high cholesterol. My brother also has type 2 diabetes." },
...
const michaelWed = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-michael-wed_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had type 2 diabetes and high blood pressure, and passed away from a stroke at age 68. My mother has high blood pressure and high cholesterol. My brother also has type 2 diabetes." },
...
const michaelThu = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-michael-thu_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had type 2 diabetes and high blood pressure, and passed away from a stroke at age 68. My mother has high blood pressure and high cholesterol. My brother also has type 2 diabetes." },
...
const angelaTue = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-angela-tue_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had high blood pressure and Stage 4 chronic kidney disease. My mother had high blood pressure and suffered a stroke at age 72." },
...
const angelaWed = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-angela-wed_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had high blood pressure and Stage 4 chronic kidney disease. My mother had high blood pressure and suffered a stroke at age 72." },
...
const angelaThu = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-angela-thu_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had high blood pressure and Stage 4 chronic kidney disease. My mother had high blood pressure and suffered a stroke at age 72." },
