...
const michaelTue = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-michael-tue_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling', 'kidney', 'eskd', 'dialysis'], response: "My father had type 2 diabetes and high blood pressure, and passed away from a stroke at age 68. My mother has high blood pressure and high cholesterol. My brother also has type 2 diabetes. No one in my family has had kidney disease, and no one has ever been on dialysis." },
    ...
    { id: 'w2-michael-tue_hosp', topic: 'Hospitalization / ED visits', field: 'hospitalization', keywords: ['hospital', 'hospitalization', 'admit', 'admission', 'emergency room', 'ed', 'er', 'visit'], response: "No, I haven't had any recent hospitalizations or emergency room visits." },
...
const michaelWed = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-michael-wed_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling', 'kidney', 'eskd', 'dialysis'], response: "My father had type 2 diabetes and high blood pressure, and passed away from a stroke at age 68. My mother has high blood pressure and high cholesterol. My brother also has type 2 diabetes. No one in my family has had kidney disease, and no one has ever been on dialysis." },
    ...
    { id: 'w2-michael-wed_hosp', topic: 'Hospitalization / ED visits', field: 'hospitalization', keywords: ['hospital', 'hospitalization', 'admit', 'admission', 'emergency room', 'ed', 'er', 'visit'], response: "No, I haven't had any recent hospitalizations or emergency room visits." },
...
const michaelThu = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-michael-thu_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling', 'kidney', 'eskd', 'dialysis'], response: "My father had type 2 diabetes and high blood pressure, and passed away from a stroke at age 68. My mother has high blood pressure and high cholesterol. My brother also has type 2 diabetes. No one in my family has had kidney disease, and no one has ever been on dialysis." },
    ...
    { id: 'w2-michael-thu_hosp', topic: 'Hospitalization / ED visits', field: 'hospitalization', keywords: ['hospital', 'hospitalization', 'admit', 'admission', 'emergency room', 'ed', 'er', 'visit'], response: "No, I haven't had any recent hospitalizations or emergency room visits." },
...
const angelaTue = makeCase({
  ...
  VITALS: { bp: '142/86', bpRepeat: '140/84', hr: '74', rr: '16', temp: '98.5°F', weight: '96 kg', height: "5'2\"", bmi: '36.3',
  ...
  LABS: [
    ...
    { label: 'AST', value: '20', unit: 'U/L', flag: 'normal' },
    { label: 'ALT', value: '19', unit: 'U/L', flag: 'normal' },
    { label: 'Total cholesterol', value: '238', unit: 'mg/dL', flag: 'high' },
    { label: 'LDL-C', value: '148', unit: 'mg/dL', flag: 'high', note: 'Markedly elevated' },
    { label: 'HDL-C', value: '41', unit: 'mg/dL', flag: 'normal' },
    { label: 'Triglycerides', value: '185', unit: 'mg/dL', flag: 'normal' },
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-angela-tue_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling', 'kidney', 'eskd', 'dialysis', 'cholesterol', 'hyperlipidemia'], response: "My father had high blood pressure, high cholesterol, and Stage 4 chronic kidney disease. My mother had high blood pressure and suffered a stroke at age 72. My sister also has high cholesterol and high blood pressure." },
    ...
    { id: 'w2-angela-tue_hosp', topic: 'Hospitalization / ED visits', field: 'hospitalization', keywords: ['hospital', 'hospitalization', 'admit', 'admission', 'emergency room', 'ed', 'er', 'visit'], response: "No, I have not had any recent hospitalizations or emergency department visits." },
...
const angelaWed = makeCase({
  ...
  VITALS: { bp: '136/82', bpRepeat: '134/80', hr: '72', rr: '16', temp: '98.4°F', weight: '95 kg', height: "5'2\"", bmi: '35.9',
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-angela-wed_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling', 'kidney', 'eskd', 'dialysis', 'cholesterol', 'hyperlipidemia'], response: "My father had high blood pressure, high cholesterol, and Stage 4 chronic kidney disease. My mother had high blood pressure and suffered a stroke at age 72. My sister also has high cholesterol and high blood pressure." },
    ...
    { id: 'w2-angela-wed_hosp', topic: 'Hospitalization / ED visits', field: 'hospitalization', keywords: ['hospital', 'hospitalization', 'admit', 'admission', 'emergency room', 'ed', 'er', 'visit'], response: "No, I have not had any recent hospitalizations or emergency department visits." },
...
const angelaThu = makeCase({
  ...
  VITALS: { bp: '132/80', bpRepeat: '130/78', hr: '70', rr: '16', temp: '98.3°F', weight: '93 kg', height: "5'2\"", bmi: '35.2',
    flags: { bp: 'warn', bpRepeat: 'warn', bmi: 'high' } },
  LABS: [
    { label: 'Sodium', value: '139', unit: 'mEq/L', flag: 'normal' },
    { label: 'K', value: '4.5', unit: 'mEq/L', flag: 'normal' },
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-angela-thu_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling', 'kidney', 'eskd', 'dialysis', 'cholesterol', 'hyperlipidemia'], response: "My father had high blood pressure, high cholesterol, and Stage 4 chronic kidney disease. My mother had high blood pressure and suffered a stroke at age 72. My sister also has high cholesterol and high blood pressure." },
    ...
    { id: 'w2-angela-thu_hosp', topic: 'Hospitalization / ED visits', field: 'hospitalization', keywords: ['hospital', 'hospitalization', 'admit', 'admission', 'emergency room', 'ed', 'er', 'visit'], response: "No, I have not had any recent hospitalizations or emergency department visits." },
...
const davidTue = makeCase({
  ...
  LABS: [
    ...
    { label: 'SCr', value: '1.82', unit: 'mg/dL', flag: 'warn' },
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-david-tue_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had high blood pressure and a heart attack at age 54. My mother has high blood pressure and type 2 diabetes. My brother had bypass surgery (CABG) at age 58." },
...
const davidWed = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-david-wed_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had high blood pressure and a heart attack at age 54. My mother has high blood pressure and type 2 diabetes. My brother had bypass surgery (CABG) at age 58." },
...
const davidThu = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'w2-david-thu_fh', topic: 'Family history', field: 'familyHistory', keywords: ['family history', 'father', 'mother', 'parents', 'brother', 'sister', 'sibling'], response: "My father had high blood pressure and a heart attack at age 54. My mother has high blood pressure and type 2 diabetes. My brother had bypass surgery (CABG) at age 58." },
