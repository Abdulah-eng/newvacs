...
const davidTue = makeCase({
  id: 'w2-david-tue',
  PATIENT: { name: 'David Chen', age: 60, sex: 'male', ethnicity: 'East Asian', mrn: 'C2-441098' },
  ENCOUNTER: { week: 'Week 2', 
  ...
  VITALS: { bp: '138/82', bpRepeat: '136/80', hr: '68', weight: '88 kg', height: "5'9\"", bmi: '28.6',
  ...
  LABS: [
    ...
    { label: 'HDL-C', value: '44', unit: 'mg/dL', flag: 'normal' },
    { label: 'Triglycerides', value: '180', unit: 'mg/dL', flag: 'normal' },
  ...
  MEDICATIONS: [
    { name: 'Lisinopril', dose: '40 mg', route: 'PO', freq: 'daily', indication: 'HTN / kidney protection', notes: '' },
    { name: 'Empagliflozin', dose: '10 mg', route: 'PO', freq: 'daily', indication: 'T2D / kidney protection', notes: '' },
    { name: 'Metformin', dose: '1000 mg', route: 'PO', freq: 'twice daily', indication: 'T2D', notes: '' },
    { name: 'Atorvastatin', dose: '20 mg', route: 'PO', freq: 'daily', indication: 'Hyperlipidemia', notes: '' },
  ],
  ALLERGIES: [{ substance: 'Sulfa (trimethoprim/sulfamethoxazole)', reaction: 'Hives' }],
  IMMUNIZATIONS: [
    { name: 'Influenza', status: 'Up to date', flag: 'normal' },
    { name: 'COVID-19', status: 'Up to date', flag: 'normal' },
    { name: 'Pneumococcal', status: 'None documented', flag: 'warn' },
