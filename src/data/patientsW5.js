...
const sarahTue = makeCase({
  ...
  LABS: [
    { name: 'Sodium', value: '139', unit: 'mEq/L', range: '135-145' },
    { name: 'Potassium', value: '4.2', unit: 'mEq/L', range: '3.5-5.0' },
    { name: 'Chloride', value: '101', unit: 'mEq/L', range: '96-106' },
    { name: 'Bicarbonate', value: '24', unit: 'mEq/L', range: '22-29' },
    { name: 'BUN', value: '12', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '0.8', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'Glucose', value: '92', unit: 'mg/dL', range: '70-99' },
    { name: 'TSH', value: '2.1', unit: 'mIU/L', range: '0.4-4.0' },
    { name: 'CBC', value: 'Unremarkable', unit: '', range: 'Normal' }
  ],
...
const sarahWed = makeCase({
  ...
  LABS: [
    ...
    { name: 'BUN', value: '12', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '0.8', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '>90', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '20', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '18', unit: 'U/L', range: '0-35' },
    { name: 'Glucose', value: '91', unit: 'mg/dL', range: '70-99' }
  ],
  ALERTS: [],
...
const sarahThu = makeCase({
  ...
  LABS: [
    { name: 'Sodium', value: '139', unit: 'mEq/L', range: '135-145' },
    { name: 'Potassium', value: '4.1', unit: 'mEq/L', range: '3.5-5.0' },
    { name: 'BUN', value: '12', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '0.8', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '>90', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '19', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '18', unit: 'U/L', range: '0-35' },
    { name: 'Glucose', value: '90', unit: 'mg/dL', range: '70-99' }
  ],
  ALERTS: [],
...
const jessicaTue = makeCase({
  ...
  LABS: [
    { name: 'Sodium', value: '140', unit: 'mEq/L', range: '135-145' },
    { name: 'Potassium', value: '4.2', unit: 'mEq/L', range: '3.5-5.0' },
    { name: 'BUN', value: '14', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '0.9', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '>90', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '22', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '25', unit: 'U/L', range: '0-35' },
    { name: 'Glucose', value: '97', unit: 'mg/dL', range: '70-99' },
    { name: 'TSH', value: '2.0', unit: 'mIU/L', range: '0.4-4.0' }
  ],
...
const jessicaWed = makeCase({
  ...
  LABS: [
    { name: 'Sodium', value: '140', unit: 'mEq/L', range: '135-145' },
    { name: 'Potassium', value: '4.1', unit: 'mEq/L', range: '3.5-5.0' },
    { name: 'BUN', value: '13', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '0.9', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '>90', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '22', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '23', unit: 'U/L', range: '0-35' },
...
const jessicaThu = makeCase({
  ...
  LABS: [
    { name: 'Sodium', value: '139', unit: 'mEq/L', range: '135-145' },
    { name: 'Potassium', value: '4.0', unit: 'mEq/L', range: '3.5-5.0' },
    { name: 'BUN', value: '13', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '0.8', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '>90', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '20', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '21', unit: 'U/L', range: '0-35' },
    { name: 'Glucose', value: '92', unit: 'mg/dL', range: '70-99' }
  ],
  ALERTS: [],
...
const davidTue = makeCase({
  ...
  LABS: [
    { name: 'Sodium', value: '139', unit: 'mEq/L', range: '135-145' },
    { name: 'Potassium', value: '4.1', unit: 'mEq/L', range: '3.5-5.0' },
    { name: 'BUN', value: '16', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '1.0', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '89', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '24', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '26', unit: 'U/L', range: '0-35' },
    { name: 'Glucose', value: '99', unit: 'mg/dL', range: '70-99' },
    { name: 'TSH', value: '1.8', unit: 'mIU/L', range: '0.4-4.0' },
    { name: 'CBC', value: 'Normal', unit: '', range: 'Normal' }
  ],
...
const davidWed = makeCase({
  ...
  LABS: [
    ...
    { name: 'Serum Creatinine', value: '1.0', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '89', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '23', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '24', unit: 'U/L', range: '0-35' },
    { name: 'Glucose', value: '101', unit: 'mg/dL', range: '70-99' },
    { name: 'Total Cholesterol', value: '190', unit: 'mg/dL', range: '<200' },
    { name: 'LDL-C', value: '109', unit: 'mg/dL', range: '<100' },
    { name: 'HDL-C', value: '43', unit: 'mg/dL', range: '>40' },
    { name: 'Triglycerides', value: '181', unit: 'mg/dL', range: '<150' }
  ],
  ALERTS: [],
...
const davidThu = makeCase({
  ...
  LABS: [
    { name: 'Sodium', value: '140', unit: 'mEq/L', range: '135-145' },
    { name: 'Potassium', value: '4.1', unit: 'mEq/L', range: '3.5-5.0' },
    { name: 'BUN', value: '15', unit: 'mg/dL', range: '8-20' },
    { name: 'Serum Creatinine', value: '1.0', unit: 'mg/dL', range: '0.6-1.2' },
    { name: 'eGFR', value: '88', unit: 'mL/min/1.73m²', range: '>=60' },
    { name: 'AST', value: '22', unit: 'U/L', range: '0-35' },
    { name: 'ALT', value: '24', unit: 'U/L', range: '0-35' },
    { name: 'Glucose', value: '99', unit: 'mg/dL', range: '70-99' },
    { name: 'Total Cholesterol', value: '188', unit: 'mg/dL', range: '<200' },
    { name: 'LDL-C', value: '106', unit: 'mg/dL', range: '<100' },
    { name: 'HDL-C', value: '45', unit: 'mg/dL', range: '>40' },
    { name: 'Triglycerides', value: '176', unit: 'mg/dL', range: '<150' }
  ],
  ALERTS: [],
