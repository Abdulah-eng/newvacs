...
const caseTue = {
  ...
  LABS: [
    { label: 'A1C', value: '8.2', unit: '%', flag: 'high', note: 'Prior 7.6% (6 mo), 7.3% (12 mo) — upward trend' },
    { label: 'Glucose', value: '176', unit: 'mg/dL', flag: 'high' },
    { label: 'Na', value: '138', unit: 'mmol/L', flag: 'normal' },
    { label: 'K', value: '4.2', unit: 'mmol/L', flag: 'normal' },
    { label: 'Cl', value: '101', unit: 'mmol/L', flag: 'normal' },
    { label: 'CO2', value: '26', unit: 'mmol/L', flag: 'normal' },
    { label: 'BUN', value: '16', unit: 'mg/dL', flag: 'normal' },
    { label: 'SCr', value: '0.88', unit: 'mg/dL', flag: 'normal' },
    ...
    { label: 'Total cholesterol', value: '201', unit: 'mg/dL', flag: 'warn' },
    { label: 'LDL-C', value: '112', unit: 'mg/dL', flag: 'warn' },
    { label: 'HDL-C', value: '44', unit: 'mg/dL', flag: 'normal' },
    { label: 'Triglycerides', value: '223', unit: 'mg/dL', flag: 'high' },
    { label: 'UACR', value: 'No result on file', unit: '', flag: 'missing', note: 'Never obtained — order at this visit' },
  ],

  ALERTS: [
    { level: 'high', text: 'Office BP 146/92 → 144/90 mmHg: Stage 2 hypertension in a patient with diabetes (goal <130/80).' },
    { level: 'high', text: 'A1C 8.2% and rising over 12 months despite metformin — above individualized goal.' },
    { level: 'warn', text: 'UACR has never been obtained in a patient with diabetes + hypertension.' },
    { level: 'info', text: 'No statin currently prescribed in a 54-year-old with diabetes.' },
  ],

  PROBLEMS: [
    { name: 'Essential hypertension', detail: 'Office BP rising; on lisinopril + HCTZ', flag: 'high' },
    { name: 'Type 2 diabetes mellitus', detail: 'A1C 8.2% (trend up); on metformin XR', flag: 'high' },
    { name: 'Hyperlipidemia', detail: 'LDL 112, TG 223; not on statin', flag: 'warn' },
    { name: 'Obesity', detail: 'BMI 34.8 kg/m²', flag: 'warn' },
    { name: 'Bilateral knee osteoarthritis', detail: 'Chronic; managed with PRN analgesia', flag: 'normal' },
  ],
  ...
  IMMUNIZATIONS: [
    { name: 'Influenza', status: 'Received this season', flag: 'normal' },
    { name: 'COVID-19 primary series', status: 'Completed', flag: 'normal' },
    { name: 'Pneumococcal (PCV)', status: 'Not documented', flag: 'missing' },
    { name: 'Zoster (Shingrix)', status: 'Not documented', flag: 'missing' },
    { name: 'Tdap', status: 'Last documented 11 years ago', flag: 'warn' },
  ],
  ...
  OBJECTIVE_EXTRA: [
    { label: 'General', value: 'Well-appearing, in no acute distress (intake note).' },
