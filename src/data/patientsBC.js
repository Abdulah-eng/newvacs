...
const jamesTue = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'james-tue_surg', topic: 'Surgical history', field: 'surgery', keywords: ['surgery', 'surgeries', 'procedure', 'operation', 'appendix', 'appendectomy', 'knee', 'arthroscopy'], response: 'I had my appendix out when I was 20, and a knee scope surgery when I was 55.' },
    { id: 'james-tue_homebp', topic: 'Home BP monitoring', field: 'homeBp', keywords: ['home blood pressure', 'bp at home', 'check your blood pressure', 'monitor', 'log', 'average'], response: 'I check my blood pressure at home maybe 1 to 2 times a week. My average is usually in the high 140s over 90s.' },
    { id: 'james-tue_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar a few times a week. My fasting numbers are usually around 140 to 160.' },
...
const jamesWed = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'james-wed_social', topic: 'Social / Lifestyle', field: 'social', keywords: ['live with', 'marital', 'work', 'job', 'retired', 'walk', 'exercise', 'diet', 'yard work'], response: 'I am retired and live with my wife. For activity, I occasionally do yard work, and I started walking about 3 times a week for 15-20 minutes. I also cut down on sugary drinks and eat out less.' },
    { id: 'james-wed_surg', topic: 'Surgical history', field: 'surgery', keywords: ['surgery', 'surgeries', 'procedure', 'operation', 'appendix', 'appendectomy', 'knee', 'arthroscopy'], response: 'I had my appendix out when I was 20, and a knee scope surgery when I was 55.' },
    { id: 'james-wed_homebp', topic: 'Home BP monitoring', field: 'homeBp', keywords: ['home blood pressure', 'bp at home', 'check your blood pressure', 'monitor', 'log', 'average'], response: 'I check my blood pressure at home maybe 1 to 2 times a week. My average is usually in the high 140s over 90s.' },
    { id: 'james-wed_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar a few times a week. My fasting numbers are usually around 140 to 160.' },
...
const jamesThu = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'james-thu_surg', topic: 'Surgical history', field: 'surgery', keywords: ['surgery', 'surgeries', 'procedure', 'operation', 'appendix', 'appendectomy', 'knee', 'arthroscopy'], response: 'I had my appendix out when I was 20, and a knee scope surgery when I was 55.' },
    { id: 'james-thu_homebp', topic: 'Home BP monitoring', field: 'homeBp', keywords: ['home blood pressure', 'bp at home', 'check your blood pressure', 'monitor', 'log', 'average'], response: 'I check my blood pressure at home maybe 1 to 2 times a week. My average is usually in the high 140s over 90s.' },
    { id: 'james-thu_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar a few times a week. My fasting numbers are usually around 140 to 160.' },
...
const lindaTue = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'linda-tue_surg', topic: 'Surgical history', field: 'surgery', keywords: ['surgery', 'surgeries', 'procedure', 'operation', 'gallbladder', 'cholecystectomy', 'hysterectomy'], response: 'I had my gallbladder removed, and a total abdominal hysterectomy years ago.' },
    ...
    { id: 'linda-tue_homebp', topic: 'Home BP monitoring', field: 'homeBp', keywords: ['home blood pressure', 'bp at home', 'check your blood pressure', 'monitor', 'log', 'average'], response: 'I check my blood pressure at home. My average is around 123 over 75.' },
    { id: 'linda-tue_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar regularly. My fasting readings are usually around 120 to 140.' },
...
const lindaWed = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'linda-wed_surg', topic: 'Surgical history', field: 'surgery', keywords: ['surgery', 'surgeries', 'procedure', 'operation', 'gallbladder', 'cholecystectomy', 'hysterectomy'], response: 'I had my gallbladder removed, and a total abdominal hysterectomy years ago.' },
    ...
    { id: 'linda-wed_homebp', topic: 'Home BP monitoring', field: 'homeBp', keywords: ['home blood pressure', 'bp at home', 'check your blood pressure', 'monitor', 'log', 'average'], response: 'I check my blood pressure at home. My average is around 123 over 75.' },
    { id: 'linda-wed_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar regularly. My fasting readings are usually around 120 to 140.' },
...
const lindaThu = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'linda-thu_surg', topic: 'Surgical history', field: 'surgery', keywords: ['surgery', 'surgeries', 'procedure', 'operation', 'gallbladder', 'cholecystectomy', 'hysterectomy'], response: 'I had my gallbladder removed, and a total abdominal hysterectomy years ago.' },
    ...
    { id: 'linda-thu_homebp', topic: 'Home BP monitoring', field: 'homeBp', keywords: ['home blood pressure', 'bp at home', 'check your blood pressure', 'monitor', 'log', 'average'], response: 'I check my blood pressure at home. My average is around 123 over 75.' },
    { id: 'linda-thu_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar regularly. My fasting readings are usually around 120 to 140.' },
