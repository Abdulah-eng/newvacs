...
const jamesTue = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'james-tue_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar a few times a week. My fasting numbers are usually around 150 to 160.' },
...
const jamesWed = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'james-wed_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar a few times a week. My fasting numbers are usually around 150 to 160.' },
...
const jamesThu = makeCase({
  ...
  INTERVIEW_KNOWLEDGE: [
    ...
    { id: 'james-thu_homebg', topic: 'Home glucose monitoring', field: 'glucoseMonitoring', keywords: ['blood sugar', 'glucose', 'check your sugar', 'fasting', 'finger stick', 'meter'], response: 'I check my blood sugar a few times a week. My fasting numbers are usually around 150 to 160.' },
